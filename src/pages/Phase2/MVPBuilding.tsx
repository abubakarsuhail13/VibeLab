...
export default function MVPBuilding({ onNavigate }: { onNavigate?: (page: string) => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 flex flex-col justify-center items-center text-white px-6 overflow-hidden select-none">
      {/* Immersive background lighting effects */}
      <div className="absolute top-[-20%] left-[-20%] w-[600px] h-[600px] rounded-full bg-[#2563eb]/5 blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-md w-full text-center space-y-10 relative z-10 flex flex-col items-center">
        {!errorStatus ? (
          <>
            ...
            <div className="relative flex items-center justify-center">
              <motion.div
                ...
                className="w-24 h-24 rounded-full border-t-2 border-r-2 border-b-2 border-transparent border-t-[#2563eb] border-r-[#3b82f6] border-b-[#2563eb]"
              />
              <motion.div
                animate={{ scale: [0.9, 1.1, 0.9] }}
                transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                className="absolute w-16 h-16 rounded-full bg-[#2563eb]/10 flex items-center justify-center border border-[#2563eb]/15"
              >
            ...
            <div className="space-y-3">
              <h2 className="font-bebas text-4xl sm:text-5xl tracking-[0.2em] text-[#2563eb] leading-none">
                BUILDING YOUR MVP
              </h2>
            ...
            <div className="h-14 flex items-center justify-center">
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  className="text-slate-650 text-sm sm:text-base font-sans font-medium tracking-wide max-w-sm leading-relaxed"
                >
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-white border border-rose-500/20 backdrop-blur-md space-y-6 flex flex-col items-center"
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed font-sans px-2">
                ...
                <span className="block mt-2 text-rose-300 font-mono text-[10px] p-2 bg-white rounded-md border border-slate-200 whitespace-pre-wrap select-text">
                  {errorStatus}
                </span>
              </p>
            </div>
            ...
            <div className="flex gap-3 w-full">
              <button
                ...
                className="flex-1 px-4 py-3 bg-white border border-slate-200 hover:border-slate-300 text-xs font-black font-jetbrains text-slate-500 hover:text-white rounded-xl transition-all cursor-pointer uppercase"
              >
                Go Back to Screens
              </button>
              <button
