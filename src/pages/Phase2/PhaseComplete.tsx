              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-10 scrollbar-thin select-text">
                ...
                <div className="space-y-4">
                  <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                    <FileText className="w-5 h-5" /> 1. Understand Your Idea
                  </h4>
                ...
                <div className="space-y-4 border-t border-slate-200 pt-8">
                  <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                    <ListTodo className="w-5 h-5" /> 2. Plan Your Features
                  </h4>
                ...
                {projectData.journey && (
                  <div className="space-y-4 border-t border-slate-200 pt-8">
                    <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                      <Compass className="w-5 h-5" /> 3. Design the User Experience
                    </h4>
                ...
                <div className="space-y-4 border-t border-slate-200 pt-8">
                  <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                    <Monitor className="w-5 h-5" /> 4. Create Your Product Design
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {projectData.mvp?.mvp_html && (
                  <div className="space-y-4 border-t border-slate-200 pt-8">
                    <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                      <FileCode2 className="w-5 h-5" /> 5 & 6. Build Your Product & Learn How Your Product Works
                    </h4>
                ...
                {projectData.mvp?.product_description && (
                  <div className="space-y-4 border-t border-slate-200 pt-8">
                    <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                      <FileText className="w-5 h-5" /> 7. Tell Your Product Story
                    </h4>
                ...
                {projectData.mvp?.demo_script && (
                  <div className="space-y-4 border-t border-slate-200 pt-8">
                    <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                      <HelpCircle className="w-5 h-5" /> 9. Practice Your Presentation
                    </h4>
                ...
                {projectData.mvp?.builder_reflection && (
                  <div className="space-y-4 border-t border-slate-200 pt-8">
                    <h4 className="font-bebas text-xl tracking-widest text-[#2563eb] flex items-center gap-2">
                      <Users className="w-5 h-5" /> 6. Learn How Your Product Works (Key Lessons)
                    </h4>
