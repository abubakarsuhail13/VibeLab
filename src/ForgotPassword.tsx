...
import { Mail, ShieldQuestion, ArrowLeft, ArrowRight, AlertCircle, Loader2, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 bg-slate-50 flex flex-col items-center justify-center">
      ...
      >
        ...
        <h2 className="font-display text-3xl font-bold text-slate-900 text-center mb-2">Reset Password</h2>
        <p className="text-slate-500 text-center mb-10 font-medium">We'll email you a secure link</p>
        ...
        {success ? (
          ...
          >
            <div className="p-6 bg-emerald-50 rounded-[2rem] border border-emerald-100 mb-8">
              ...
              <p className="text-emerald-800 font-bold mb-2">Email Sent!</p>
              <p className="text-emerald-600 text-sm font-medium">Check your inbox for instructions to reset your password.</p>
            </div>
            <button 
              onClick={() => onNavigate('login')}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Account Email</label>
